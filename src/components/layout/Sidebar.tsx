...
import {
  LayoutDashboard, Radar, Kanban, Users, Settings, ChevronLeft, ChevronRight, FileText, MessageSquare
} from 'lucide-react'
...
const navItems = [
  ...
  { to: '/app/messages', label: 'Message Records', icon: MessageSquare, end: false, role: 'user' },
